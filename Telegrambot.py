...
#CoinMarketCap API
CoinMktCap_API: Final = '0e9e73ba-baa2-42e3-8f58-8217eeb1caee'

# Telegram Bot Token
Telegram_Token: Final = '6488929133:AAGmDyAwvej_Th90qfEYGvdLU0uDE7GXgR8'
BotUserName: Final = '@ECON3086_CryptoPriceAlertbot'
CRYPTO_INPUT = 1
...
def main() -> None:
    ...
    updater = Updater('6488929133:AAGmDyAwvej_Th90qfEYGvdLU0uDE7GXgR8', None)
